...
import { MAINURL, APIS, Photo } from '../../configs/configs';
import React from 'react';


export default function CategoryItem({categorySection, isMock}){
            ...
            <div  className="cataloge-item">
                <div className="cataloge-photo-item">
                    <div className="cataloge-photo">
                        {
                            isMock === false ? <img src={Photo+categorySection.images[0].url}/>
                            : <img src={categorySection.images}/>
                        }
